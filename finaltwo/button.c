...
#define PORT_BUTTON    GPIO_PORTE_DATA_R
...
uint8_t button_getButton() {
	...
	// INSERT CODE HERE!
//    char button_1 = !(PORT_BUTTON) & 1;
//    char button_2 = !(PORT_BUTTON >> 1) & 1;
//    char button_3 = !(PORT_BUTTON >> 2) & 1;
//    char button_4 = !(PORT_BUTTON >> 3) & 1;

    if ((GPIO_PORTE_DATA_R >> 3) == 0x00){
        return 4;
    }
    if ((GPIO_PORTE_DATA_R >> 2) == 0x02){
        return 3;
    }
    if ((GPIO_PORTE_DATA_R >> 1) == 0x06){
        return 2;
    }
    if (GPIO_PORTE_DATA_R == 0x0E){
        return 1;
    }
    return 0;
